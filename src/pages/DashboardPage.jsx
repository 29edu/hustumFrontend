    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-base)" }}>
      <div className="max-w-400 mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        >
          ...
          <div className="relative z-10 p-4 sm:p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            {/* Left – greeting */}
            <div className="min-w-0">
              ...
              <h1
                className="text-xl sm:text-4xl font-extrabold leading-tight truncate"
                style={{ color: isDark ? "#ffffff" : "#0f172a" }}
              >
                {user?.name || user?.username || "Welcome back"} 👋
              </h1>
              <p
                className="text-xs sm:text-sm mt-1 max-w-md hidden sm:block"
            ...
            {/* Right – live clock */}
            <div
              className="rounded-xl sm:rounded-2xl px-3 sm:px-5 py-2.5 sm:py-4 shrink-0 text-right"
              style={{
            ...
            >
              <p
                className="text-xl sm:text-4xl font-mono font-bold tracking-tight tabular-nums"
                style={{ color: isDark ? "#ffffff" : "#0f172a" }}
              >
                {formatLiveTime()}
              </p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="xl:col-span-2 space-y-4 sm:space-y-6">
            ...
            >
              ...
              {/* Task list */}
              <div className="p-4 sm:p-5 space-y-2 max-h-105 overflow-y-auto">
                {activeTab === "today" ? (
                  todayTodos.length > 0 ? (
                    todayTodos.map((todo) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* badge */}
                          <span
                            className="px-2 py-0.5 rounded-full text-xs font-semibold shrink-0 hidden sm:inline-flex"
                            style={{
                              backgroundColor: isCompleted
                                ? isDark
                                  ? "rgba(34,197,94,0.2)"
                  ...
                  upcomingTodos.map((todo) => {
                    ...
                    return (
                      ...
                      >
                        <div className="shrink-0 w-5 h-5 rounded-full border-2 border-gray-300 flex items-center justify-center">
                          {isUrgent && (
            ...
            >
              ...
              <div className="p-3 sm:p-5 space-y-1 max-h-64 overflow-y-auto">
                {hours.map((hour) => {
                  ...
                  return (
                    <div key={hour} className="flex items-start gap-2 group">
                      <div
                        className="w-10 sm:w-14 text-xs font-mono font-semibold shrink-0 pt-2"
                        style={{ color: "var(--text-faint)" }}
                      >
                        {hour.toString().padStart(2, "0")}:00
                      </div>
                      <div
                        className="flex-1 border-l-2 border-dashed pl-3 py-1 min-h-7 flex flex-wrap gap-1.5"
                        style={{
                          borderColor:
                        ...
                        {tasksAtHour.map((task, idx) => {
                          ...
                          return (
                            <span
                              ...
                              className={`${colorClass} text-white px-2 py-0.5 rounded-lg text-xs font-medium flex items-center gap-1 max-w-35 sm:max-w-none`}
                            >
                              {task.completed && <FaCheckCircle size={9} />}
                              <span
                                className={`truncate ${task.completed ? "line-through" : ""}`}
                              >
                                {task.title}
                              </span>
                              {task.isStart &&
